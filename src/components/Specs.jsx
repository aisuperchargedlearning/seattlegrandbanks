...
const Specs = () => {
  ...
  const generalSpecifications = [
    ...
    { label: 'Freshwater Tank (Liter and material)', value: '750L, Stainless steel' },
  ...
  const additionalSpecifications = [
    ...
    { label: 'Fresh Water Capacity', value: '750L (198 gal), Stainless steel' },
    { label: 'Engines', value: '2x Cummins BT6, 150HP each' },

    ...
    <section id="contact" className="py-16">
      <div className="max-w-3xl mx-auto text-center">
        ...
        <p className="text-lg mb-8">
          Welcome to SeattleGrandBanks.com, your premier destination for classic trawler yachts. We specialize in showcasing and connecting enthusiasts with exceptional vessels like the 1991 Grand Banks 36 Europa. We are dedicated to providing detailed information and assistance to help you find the perfect yacht for your maritime adventures. For inquiries, please contact us at info@seattlegrandbanks.com.
        </p>
        <div className="mb-8">
